...
import { createPatientForm } from "./graphql/mutations";
const client = generateClient();
export default function PatientFormCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPatientForm.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PatientFormCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
